...
RECAPTCHA_PUBLIC_KEY = '6LdchoQqAAAAANk2g1J7IXWKaOX0zVjuk4HE1d5J'  
RECAPTCHA_PRIVATE_KEY = '6LdchoQqAAAAALtZDLIVk43YQkYVVS8hbcQgQm-r'
LOGIN_URL = 'index'
...
DATABASES = {
    'default': {
        ...
        'NAME': os.path.join('/tmp', 'db.sqlite3'),  # Lưu database trong thư mục tạm
    }
}
